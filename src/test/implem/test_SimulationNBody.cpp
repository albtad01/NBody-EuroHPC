...
TEST_CASE("n-body - gpu+optim", "[dmb]")
{
    ...
    SECTION("fp32 - n=128 - i=1 - random") { test_nbody_cpu_optim(128, 2e+08, 3600, 1, "random", 1e-3); }
    ...
    SECTION("fp32 - n=128 - i=1 - galaxy") { test_nbody_cpu_optim(128, 2e+08, 3600, 1, "galaxy", 1e-2); }
